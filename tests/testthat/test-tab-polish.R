...
test_that("export module UI renders polished result downloads", {
  ...
  expect_true(grepl("export-download_predictive_plots", html, fixed = TRUE))
  expect_true(grepl("export-predictive_target", html, fixed = TRUE))
  expect_true(grepl("export-predictive_horizon_minutes", html, fixed = TRUE))
  expect_true(grepl("export-predictive_model", html, fixed = TRUE))
